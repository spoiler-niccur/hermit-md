...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || '07_27_H_E_R_M_I_T_M946CXR',
    ...
    BOT_NAME: process.env.BOT_NAME || 'Hakim',
    ...
    BOT_INFO: process.env.BOT_INFO || 'HAKIM-MD; Abdulhakim;254745590936;https://i.imgur.com/6oRG106.jpeg',

    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ʜAKIM-MD;ᴀbdulhakim;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,

    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'HAKIM-MD;Abdulhakim' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '254745590936,0',
